...
public final class PasswordServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ie.gmit.ds.PasswordInput,
      ie.gmit.ds.PasswordOutput> getHashMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hash",
      requestType = ie.gmit.ds.PasswordInput.class,
      responseType = ie.gmit.ds.PasswordOutput.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ie.gmit.ds.PasswordInput,
      ie.gmit.ds.PasswordOutput> getHashMethod() {
    io.grpc.MethodDescriptor<ie.gmit.ds.PasswordInput, ie.gmit.ds.PasswordOutput> getHashMethod;
      ...
      synchronized (PasswordServiceGrpc.class) {
        if ((getHashMethod = PasswordServiceGrpc.getHashMethod) == null) {
          PasswordServiceGrpc.getHashMethod = getHashMethod =
              io.grpc.MethodDescriptor.<ie.gmit.ds.PasswordInput, ie.gmit.ds.PasswordOutput>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hash"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ie.gmit.ds.PasswordInput.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ie.gmit.ds.PasswordOutput.getDefaultInstance()))
  ...
  public static abstract class PasswordServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hash(ie.gmit.ds.PasswordInput request,
        io.grpc.stub.StreamObserver<ie.gmit.ds.PasswordOutput> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ie.gmit.ds.PasswordInput,
                ie.gmit.ds.PasswordOutput>(
                  this, METHODID_HASH)))
          .addMethod(
            getValidateMethod(),
            asyncUnaryCall(
  ...
  public static final class PasswordServiceBlockingStub extends io.grpc.stub.AbstractStub<PasswordServiceBlockingStub> {
    ...
    /**
     */
    public ie.gmit.ds.PasswordOutput hash(ie.gmit.ds.PasswordInput request) {
  ...
  public static final class PasswordServiceFutureStub extends io.grpc.stub.AbstractStub<PasswordServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ie.gmit.ds.PasswordOutput> hash(
        ie.gmit.ds.PasswordInput request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HASH:
          serviceImpl.hash((ie.gmit.ds.PasswordInput) request,
              (io.grpc.stub.StreamObserver<ie.gmit.ds.PasswordOutput>) responseObserver);
          break;
  ...
  private static abstract class PasswordServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ie.gmit.ds.PasswordOuterClass.getDescriptor();
    }
